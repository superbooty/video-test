  ...
  <div class="comm-container">
    <div class="broadcaster">
      ...
      <div class="text-img-msg">
        <label :class="{'products': msgComposition['ids']}"></label>
        <input
          class="msg txt-input"
          v-model="message"
          ref="messageInput"
      ...
      <div class="img-picker" :class="{'on': msgComposition['images']}">
        <ul>
...
export default {
  ...
  setup(props, {emit}) {
    ...
    const messages = ref([]);
    const msgComposition = ref({images: false, ids: false, text: true})
    ...
    const setMsgComposition = (option, value) => {
      ...
      for (const property in msgComposition.value) {
        if (msgComposition.value[property]) {
          msgComposition.value[property] = false;
        }
      }
    ...
    const sendMsg = () => {
      if (message.value && msgComposition.value['ids']) {
